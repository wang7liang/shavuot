...
import com.ws.shavuot.model.AuthenticationRequest;
import com.ws.shavuot.model.AuthenticationResponse;
...
public class AuthenticationController {
    ...
    public ResponseEntity<?> authenticationRequest(@RequestBody AuthenticationRequest authenticationRequest, Device device)
        ...
        //login record
        securityService.saveUserLoginInfo(new UserLoginInfo(userDetails.getId(), DateUtils.getCurrentTime(), DateUtils.getCurrentTime()));
        // Return the token
